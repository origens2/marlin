...
#define STRING_CONFIG_H_AUTHOR "LUCAS TEODORO VITAL" // Who made the changes.
...
//#define PARKING_EXTRUDER
  ...
  #define P DER_SOLENOIDS_PINS_ACTIVE LOW  // LOW or HIGH pin signal energizes the coil
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 51.20
  #define DEFAULT_Ki 4.40
  #define DEFAULT_Kd 148.89
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //D-force
  #define DEFAULT_bedKp 668.35
  #define DEFAULT_bedKi 129.09
  #define DEFAULT_bedKd 865.09
...
#define DELTA
  ...
  #define DELTA_HEIGHT 303.91 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -5.0, -0.57, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 105.26 //mm  Get this value from auto calibrate
...
#define X_MAX_LENGTH_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
...
#define MANUAL_Z_HOME_POS 305.94 // Distance between the nozzle to printbed after homing
